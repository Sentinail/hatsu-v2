  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        const latestData = await anilist.fetchLatestReleaseAnime({ isCached: true })
        ...
        const upcomingData = await anilist.fetchUpcomingEpisodes({ isCached: true })
    ...
    <div className="min-h-screen bg-black text-white">
        ...
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center gap-8">
            ...
            <nav className="hidden md:flex items-center space-x-6">
              ...
              <Link href="/browse" className="text-zinc-400 hover:text-purple-400 transition">
                Browse
              </Link>
              <Link href="/genres" className="text-zinc-400 hover:text-purple-400 transition">
                Genres
              </Link>
              <Link href="/schedule" className="text-zinc-400 hover:text-purple-400 transition">
                Schedule
              </Link>
            </nav>
          </div>
          <div className="flex items-center gap-4">
            ...
            <Link href="/notifications" className="p-2 text-zinc-400 hover:text-white transition">
              <Bell size={20} />
            </Link>
            <div className="hidden md:flex gap-2">
              <Link href="/login">
                <Button variant="ghost" className="text-white hover:text-purple-400 hover:bg-zinc-800">
                  Login
                </Button>
              </Link>
              <Link href="/register">
            ...
            <Button variant="ghost" className="md:hidden p-2 text-zinc-400 hover:text-white hover:bg-transparent">
              <Menu size={24} />
            </Button>
          </div>
        </div>
      ...
      <main className="pt-16">
        ...
        <section className="w-full">
          <AnimeCarousel animeList={popularAnime} isLoading={isLoading.popular} />
        </section>
        ...
        <section className="container mx-auto px-4 py-12">
          <div className="flex justify-between items-center mb-6">
            ...
            <Link href="/latest" className="text-sm text-purple-400 hover:text-purple-300">
              View All
            </Link>
          </div>
          <AnimeGrid animeList={latestAnime} isLoading={isLoading.latest} category="LATEST" />
        </section>
        ...
        <section className="container mx-auto px-4 py-12">
          <div className="flex justify-between items-center mb-6">
            ...
            <Link href="/trending" className="text-sm text-purple-400 hover:text-purple-300">
              View All
            </Link>
          </div>
          <AnimeGrid animeList={trendingAnime} isLoading={isLoading.trending} category="TRENDING" />
        </section>
        ...
        <section className="container mx-auto px-4 py-12">
          <div className="flex justify-between items-center mb-6">
            ...
            <Link href="/schedule" className="text-sm text-purple-400 hover:text-purple-300">
              Full Schedule
            </Link>
          </div>
          <UpcomingEpisodes episodeList={upcomingEpisodes} isLoading={isLoading.upcoming} />
        </section>
      </main>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-zinc-400 text-sm">
                Your ultimate destination for anime streaming. Watch the latest episodes, discover new series, and join
                a community of anime lovers.
              </p>
            </div>
            <div>
              ...
              <ul className="space-y-2 text-zinc-400 text-sm">
                ...
                <li>
                  <Link href="/browse" className="hover:text-purple-400">
                    Browse
                  </Link>
                </li>
                <li>
                  <Link href="/genres" className="hover:text-purple-400">
                    Genres
                  </Link>
                </li>
                <li>
                  <Link href="/schedule" className="hover:text-purple-400">
                    Schedule
                  </Link>
                </li>
              </ul>
